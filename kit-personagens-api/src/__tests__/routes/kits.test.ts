...
describe('POST /admin/kits', () => {
  ...
  it('creates the kit without touching Stripe, regardless of price', async () => {
...
describe('PATCH /admin/kits/:id', () => {
  ...
  function mockPatchClient(kitResult: any) {
  ...
  it('updates the kit without touching Stripe, regardless of price', async () => {
    mockPatchClient(KIT)

    const res = await patch(app, 'kit-1', {
      title: 'Kit Updated',
      price: 1999,
